...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Querying Status (Active/Focused/Hovered etc.)"))
        {
            ...
            // This is useful in particular if you want to createEntity a context menu (with BeginPopupContextItem) associated to the title bar of a window.
    ...
    if (ImGui::CollapsingHeader("Layout"))
    {
        ...
        if (ImGui::TreeNode("Groups"))
        {
            ...
            // Capture the group size and createEntity widgets using the same size
        ...
        if (ImGui::TreeNode("Horizontal Scrolling"))
        {
            ...
            {
                // Display random stuff (for the sake of this trivial demo we are using basic Button+SameLine. If you want to createEntity your own time line for a real application you may be better off
    ...
    if (fonts_opened)
    {
        ...
        for (int i = 0; i < atlas->Fonts.Size; i++)
        {
            ...
            if (font_details_opened)
            {
                ...
                ImGui::PopFont();
                ImGui::DragFloat("Font mul", &font->Scale, 0.005f, 0.3f, 2.0f, "%.1f");   // Scale only this font
        ...
        ImGui::DragFloat("this window mul", &window_scale, 0.005f, 0.3f, 2.0f, "%.1f");              // mul only this window
        ImGui::DragFloat("global mul", &ImGui::GetIO().FontGlobalScale, 0.005f, 0.3f, 2.0f, "%.1f"); // mul everything
        ImGui::PopItemWidth();
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // Here we createEntity a context menu only available from the title bar.
...
// Demonstrate createEntity a window with multiple child windows.
static void ShowExampleAppLayout(bool* p_open)
{
...
// Demonstrate createEntity a simple property editor.
static void ShowExampleAppPropertyEditor(bool* p_open)
{
...
static void ShowExampleAppAutoResize(bool* p_open)
{
    ...
    static int lines = 10;
    ImGui::Text("Window will resize every-frame to the size of its content.\nNote that you probably don't want to query the window size to\noutput your content because that would createEntity a feedback loop.");
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // Define IM_VEC2_CLASS_EXTRA in imconfig.h to createEntity implicit conversions between your types and ImVec2/ImVec4.
